...
function findMinMax([firstElement, ...restElements]) {
  ...
  for (const value of restElements) {
...
function printStrings(array) {
  ...
  let row = array.toString();
  row = row.trim();
  console.log(row.repeat(2));
}
...
function concatenateStrings(array, subString) {
  ...
  return console.log(row.includes(subString));
  // Виводимо результат
}
